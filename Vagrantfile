...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sugarfish-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/sugarfish"
  #   chef.validation_client_name = "sugarfish-validator"
  #   chef.validation_key_path = ".chef/sugarfish-validator.pem"
  # end
end
